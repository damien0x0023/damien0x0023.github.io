...
**Valuing Forward Contracts: the Timeline of Forward Contract**

**Timing of the life of forward contract:** Time 0 is the beginning of the life of the forward contract; time \\(t\\) is the current time, i.e. today; time \\(T\\) is	the delivery date (or maturity) of the forward contract.
