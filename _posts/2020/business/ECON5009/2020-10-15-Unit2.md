...
Taking the dividends into account, the investor in the stock index would earn \\(-10 \text{%} + 0.25\text{%} = -9.75\text{%}\\) over the 3-month period.

According to the CAPM, the expected return on the portfolio can be computed as:

$$
    1 \text{%} + 1.5 \times (-9.75 \text{%} - 1 \text{%}) = -15.125 \text{%}
$$

The  expected  value  of  the  portfolio  at the end of the	3 months is therefore:

$$
    5050000   \times    (1 + (-15.125 \text{%}))	= 4286187.
$$
...
$$
    ...
    \text{Return on the Market} & -9.750\text{%} & -4.750\text{%} & 0.250\text{%} & 5.250\text{%} & 10.250\text{%} \\\\
    \text{Expected Return on Portfolio} & -15.125\text{%} & -7.625\text{%} & -0.125\text{%} & 7.375\text{%} & 14.875\text{%} \\\\
