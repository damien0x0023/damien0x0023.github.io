...
\\]
    ...
    price once during a 6-month  period;  r = 10%; So =25. Therefore, the annualized yield is 4% with semiannual 
    compounding. Using equation (4), the corresponding continuous-compounding yield can be computed as 3.96%.	
    Thus, from equation (5), the forward price is
...
* In  this  case,  VA  == 5050000;  VF== 1010  x  250 == 252500.	Thus,
N*  ==  5050000/252500 == 20, i.e.	20  futures  contracts  need  to	be shorted to hedge the	portfolio.
